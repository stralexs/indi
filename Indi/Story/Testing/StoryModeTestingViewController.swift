...
final class StoryModeTestingViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(presentResult(_:)), name: Notification.Name(rawValue: "com.indi.testResult.notificationKey"), object: nil)
    }
